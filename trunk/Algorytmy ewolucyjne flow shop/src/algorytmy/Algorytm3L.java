 ...
 */
public class Algorytm3L implements iAlgorytm
{
    ...
    public Algorytm3L(int iloscOsobnikow,iDane d) throws FileNotFoundException
    {
        dane = d;
    ...
    public iAlgorytm createAlg(int iloscOsobnikow, iDane d) throws FileNotFoundException, IOException {
        return new Algorytm3L(iloscOsobnikow, d);
    }
